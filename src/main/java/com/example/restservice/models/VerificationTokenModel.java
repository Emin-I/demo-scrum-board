...
public class VerificationTokenModel {
	...
	private static final int EXPIRATION = 55 * 60 * 1000;
	...
	public VerificationTokenModel(final String token, final UserModel user) {
		super();
	...
	public boolean equals(final Object obj) {
		...
		final VerificationTokenModel other = (VerificationTokenModel) obj;
